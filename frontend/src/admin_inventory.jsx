...
const res = await fetch(
  "http://localhost/project/backend/inventory.php",
  {
    method: "POST",
    body: fd,
    credentials: "include",
...
if (mode === "edit") {
  showToast("Item updated successfully!", "update");
} else {
...
const handleDelete = async () => {
  await fetch(
    `http://localhost/project/backend/inventory.php?delete_id=${deleteId}`,
    { credentials: "include" }
  );
...
return (
  ...
  <div style={{ display: "flex", minHeight: "100vh", background: "#f4f9ff" , fontFamily: "Poppins, sans-serif",}}>
    ...
    <div className="main" style={{ flex: 1, marginLeft: "250px", padding: 20 }}>
